...
describe('NetHttpService PATCH', () => {
  ...
  it('When the patch method is called with a response type of ArrayBuffer while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    ...
    const subscription = service.patch<ArrayBuffer>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the patch method is called with a response type of Blob while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
    ...
    // Act
    const subscription = service.patch<Blob>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the patch method is called with a response type of Text while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
    ...
    // Act
    const subscription = service.patch<string>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the patch method is called with a response type of Json while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
    ...
    // Act
    const subscription = service.patch<JsonTestResult>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the patch method is called without a response type while providing all callbacks, it should select the Json response type and invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
