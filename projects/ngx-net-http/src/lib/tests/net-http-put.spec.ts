...
describe('NetHttpService PUT', () => {
  ...
  it('When the put method is called with a response type of ArrayBuffer while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    ...
    const subscription = service.put<ArrayBuffer>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the put method is called with a response type of Blob while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
    ...
    // Act
    const subscription = service.put<Blob>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the put method is called with a response type of Text while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
    ...
    // Act
    const subscription = service.put<string>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the put method is called with a response type of Json while providing all callbacks, it should invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
    ...
    // Act
    const subscription = service.put<JsonTestResult>({
      body: {
        key: 'value'
      },
      options: {
  ...
  it('When the put method is called without a response type while providing all callbacks, it should select the Json response type and invoke all the callbacks, except the error callback', () => {
    // Arrange
    let onRequestSentCalled = false;
    let onReceivedResponseHeaderCalled = false;
    let onReceivedResponseHeaderResult = false;
